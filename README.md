# Husam_NPC
Adds Husam, the Shadow Thief from BG1, as a joinable NPC in SoD and BGII. Please note: BGII content is not finished.
...
So far, only the SoD content of the mod is finished. In BGII, Husam can be taken into the group and kicked out, will not accept working for Bodhi (and defend the thieves' guild in the upcoming fight), and he will react to the thief's stronghold questline.
